...
# --- Función de entorno para DummyVecEnv ---
def make_env():
    return lambda: DualTeamEnvWrapper(StrategyEnvPPOA2C2(), controlled_team=0)

# --- Inicialización del entorno y modelo A2C ---
env = DummyVecEnv([make_env()])
model = A2C("MlpPolicy", env, verbose=1, tensorboard_log="logs/a2c_vs_heuristic_v2", device="cpu")

# --- Entrenamiento desde cero ---
total_timesteps = 1_000_000
model.learn(total_timesteps=total_timesteps)
model.save("models/a2c_vs_heuristic_v2")

print("\n✅ ENTRENAMIENTO A2C COMPLETADO (1M TIMESTEPS) ✅")
