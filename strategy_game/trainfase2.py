...
from gym_strategy.envs.StrategyEnvFlexible import StrategyEnvFlexible
...
def make_env(team):
    return lambda: DualTeamEnvWrapper(
        StrategyEnvFlexible(
            board_size=(7, 5),
            units_blue=[Soldier, Soldier],
            units_red=[Soldier, Soldier],
            use_obstacles=False
        ),
...
print("\n✅ ENTRENAMIENTO PPO FLEXIBLE V1 COMPLETADO ✅")
