...
blue_path = "models/ppopruebablue2.zip"
red_path = "models/ppopruebared2.zip"
backup_dir = "backups_ppocycles2"
os.makedirs(backup_dir, exist_ok=True)

# Inicialización de modelos
blue_model = PPO("MlpPolicy", DummyVecEnv([make_env(0)]), verbose=1, tensorboard_log="logs/ppoblue2", device="cpu")
red_model = PPO("MlpPolicy", DummyVecEnv([make_env(1)]), verbose=1, tensorboard_log="logs/ppored2", device="cpu")

# Ciclos de entrenamiento alterno
start_cycle = 1
end_cycle = 10
...
for cycle in range(start_cycle, end_cycle + 1):
    ...
    # Entrenar BLUE contra red_model
    ...
    shutil.copy(red_path, os.path.join(backup_dir, f"ppopruebared_cycle{cycle}.zip"))
