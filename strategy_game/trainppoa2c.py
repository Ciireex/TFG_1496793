...
# Configuración
blue_path = "models/a2c_blue_ppo_a2c_v3.zip"
red_path = "models/a2c_red_ppo_a2c_v3.zip"
backup_dir = "backups_ppo_a2c_v3"
...
blue_model = A2C(
    ...
    verbose=1,
    tensorboard_log="logs/blue_ppo_a2c_v3",
    ent_coef=0.01,
    device="cpu"
)
...
red_model = A2C(
    ...
    verbose=1,
    tensorboard_log="logs/red_ppo_a2c_v3",
    ent_coef=0.01,
    device="cpu"
)
...
for cycle in range(start_cycle, end_cycle + 1):
    ...
    shutil.copy(blue_path, os.path.join(backup_dir, f"a2c_blue_ppo_a2c_v3_cycle{cycle}.zip"))
    ...
    shutil.copy(red_path, os.path.join(backup_dir, f"a2c_red_ppo_a2c_v3_cycle{cycle}.zip"))
