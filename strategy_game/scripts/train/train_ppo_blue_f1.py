...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/blue_f1_v3"))
...
env = make_vec_env(lambda: RedHeuristicWrapper(), n_envs=N_ENVS, seed=42)
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_blue_f1_v3"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO azul en Fase 1 (4x4) v3...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "ppo_blue_f1_v3"))
print("✅ Modelo PPO azul guardado como ppo_blue_f1_v3.zip")
