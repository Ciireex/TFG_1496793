...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/blue_f7_v3"))
...
print("🧊 Reconstruyendo modelo rojo congelado con nuevo tamaño de mapa...")
...
print("🧠 Creando modelo PPO azul (F7 v3) con arquitectura nueva...")
model = PPO(
    policy="CnnPolicy",
    env=env,
    policy_kwargs=policy_kwargs,
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_blue_f7_v3"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO azul en Fase 7 v3 vs rojo congelado F6 v2 adaptado...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "ppo_blue_f7_v3"))
print("✅ Modelo PPO azul F7 v3 guardado como ppo_blue_f7_v3.zip")
