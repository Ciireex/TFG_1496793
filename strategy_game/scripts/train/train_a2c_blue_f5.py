...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/a2c/blue_f5_v1"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
PREVIOUS_MODEL_PATH = os.path.join(MODEL_DIR, "a2c_blue_f4_v1.zip")
RED_MODEL_PATH = os.path.join(MODEL_DIR, "a2c_red_f4_v1.zip")

os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

# === WRAPPER: ROJO CON POLÍTICA FIJA ===
class FrozenRedWrapper(Env_Fase5_Knight):
    def __init__(self):
        super().__init__()
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="a2c_blue_f5_v1"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando A2C azul F5 v1 (con caballeros)...")
model.learn(total_timesteps=1_000_000, callback=callbacks, progress_bar=True)

# === GUARDADO ===
model.save(os.path.join(MODEL_DIR, "a2c_blue_f5_v1"))
print("✅ Modelo F5 v1 azul guardado.")
