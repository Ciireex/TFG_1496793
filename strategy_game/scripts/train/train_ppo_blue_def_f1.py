...
N_ENVS = 4
LOG_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../logs/ppo_blue_def_f1"))
...
env = make_vec_env(lambda: RedHeuristicWrapper(), n_envs=N_ENVS, seed=456)
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_blue_def_f1"
    )
]

# === INICIO ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO azul en Fase 2 (Def)...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO DEL MODELO ===
model.save(os.path.join(MODEL_DIR, "ppo_blue_def_f1"))
print("✅ Modelo PPO azul guardado como ppo_blue_def_f1.zip")
