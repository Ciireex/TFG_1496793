...
# === Wrapper PPO vs HeuristicCastle ===
...
checkpoint_callback = CheckpointCallback(
    save_freq=50000,
    save_path="./models/",
    name_prefix="ppo_castle_vs_heuristic_continue"
)

# === Cargar modelo PPO ya entrenado contra dummy ===
model = PPO.load("models/ppo_castle_vs_dummy", env=env, device="cpu")

# (Opcional: puedes ajustar los hyperparámetros si quieres aquí)

# === Continuar entrenamiento ===
model.learn(total_timesteps=1_000_000, callback=checkpoint_callback)
model.save("models/ppo_castle_vs_heuristic_continue")
