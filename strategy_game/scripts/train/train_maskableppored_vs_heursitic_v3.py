...
# === ENTRENAMIENTO MaskablePPO Rojo v3 VS Heurística Azul ===
print("🏁 Entrenando MaskablePPO v3 (rojo) vs heurística v2 (azul) con obstáculos (1M pasos)...")
...
model = MaskablePPO(
    ...
    env,
    verbose=1,
    tensorboard_log="./logs/maskableppored_vs_heuristic_v3/",
    device="cpu"
)

model.learn(
    total_timesteps=1_000_000,
    tb_log_name="MaskablePPO_Red_vs_Heuristic_v3",
    reset_num_timesteps=True
)

# Guardar modelo final
model.save("models/maskableppored_vs_heuristic_v3")

print("\n✅ ENTRENAMIENTO COMPLETADO Y GUARDADO: maskableppored_vs_heuristic_v3 ✅")
