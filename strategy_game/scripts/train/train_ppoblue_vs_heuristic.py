...
model = PPO(
    ...
    env_no_obs,
    verbose=1,
    tensorboard_log="./logs/ppoblue_vs_heuristic_curriculum/",
...
model.save("models/ppoblue_vs_heuristic_curriculum_v1")

print("\n✅ ENTRENAMIENTO COMPLETADO CON CURRICULUM LEARNING ✅")
