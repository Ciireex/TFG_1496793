...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/red_f6_v2"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
RED_PREV_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_red_f5_v1.zip")
BLUE_FROZEN_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_blue_f6_v2.zip")
...
print("🧊 Cargando modelo azul congelado F6 v2...")
...
print("🧠 Creando modelo PPO rojo (F6 v2) con pesos de F5...")
model = PPO(
    policy="CnnPolicy",
    env=env,
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_red_f6_v2"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO rojo en Fase 6 v2 vs azul congelado F6 v2...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "ppo_red_f6_v2"))
print("✅ Modelo PPO rojo F6 v2 guardado como ppo_red_f6_v2.zip")
