...
# === Wrapper: Rojo ataca si puede, sino se mueve aleatoriamente ===
class RandomRedWrapper(StrategyEnv_2v2Soldiers4x4):
...
N_ENVS = 4
SEED = 42
LOG_DIR = "./logs/ppo_blue_vs_randomred/"
MODEL_DIR = "./models/ppo_blue_vs_randomred/"
...
model.save(os.path.join(MODEL_DIR, "ppo_blue_f0_v0"))
print("✅ Entrenamiento de PPO azul contra equipo rojo aleatorio completado.")
