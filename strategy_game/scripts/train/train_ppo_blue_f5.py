...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/blue_f5"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
BLUE_PREV_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_blue_f4_v1.zip")
RED_FROZEN_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_red_f4_v1.zip")
...
print("🧊 Cargando modelo rojo congelado F4...")
...
# === CONFIGURACIÓN DE LA POLÍTICA PPO AZUL ===
policy_kwargs = dict(
...
print("🧠 Creando modelo PPO azul (F5) con pesos de F4...")
model = PPO(
    policy="CnnPolicy",
    env=env,
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_blue_f5_v1"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO azul en Fase 5 vs rojo congelado F4...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDAR MODELO ENTRENADO ===
model.save(os.path.join(MODEL_DIR, "ppo_blue_f5_v1"))
print("✅ Modelo PPO azul F5 guardado como ppo_blue_f5_v1.zip")
