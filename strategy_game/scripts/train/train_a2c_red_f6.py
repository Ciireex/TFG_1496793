...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/a2c/red_f6_v1"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
PREVIOUS_MODEL_PATH = os.path.join(MODEL_DIR, "a2c_red_f5_v1.zip")
BLUE_MODEL_PATH = os.path.join(MODEL_DIR, "a2c_blue_f5_v1.zip")

os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

# === ENV CON POLÍTICA AZUL CONGELADA ===
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="a2c_red_f6_v1"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando A2C rojo F6 v1 (con terreno)...")
model.learn(total_timesteps=1_000_000, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "a2c_red_f6_v1"))
print("✅ Modelo F6 v1 rojo guardado.")
