...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/red_f7_v3"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
RED_PREV_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_red_f6_v2.zip")
BLUE_FROZEN_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_blue_f7_v3.zip")
...
# === RECONSTRUIR MODELO AZUL CONGELADO (ADAPTADO AL NUEVO MAPA) ===
print("🧊 Reconstruyendo modelo azul congelado con nuevo tamaño de mapa...")
...
print("🧠 Creando modelo PPO rojo (F7 v3) con arquitectura nueva...")
model = PPO(
    policy="CnnPolicy",
    env=env,
    policy_kwargs=policy_kwargs,
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_red_f7_v3"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO rojo en Fase 7 v3 vs azul congelado F7 v3...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "ppo_red_f7_v3"))
print("✅ Modelo PPO rojo F7 v3 guardado como ppo_red_f7_v3.zip")
