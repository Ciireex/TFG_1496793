...
print("🏁 Entrenando A2C rojo vs heurística (con obstáculos, 1M pasos)...")
env = DummyVecEnv([
...
model = A2C(
    ...
    env,
    verbose=1,
    tensorboard_log="./logs/a2cred_vs_heuristic/",
    device="cpu"
)

model.learn(
    total_timesteps=1_000_000,
    tb_log_name="A2C_vs_Heuristic",  # Para identificar en TensorBoard
    reset_num_timesteps=True         # Muestra desde paso 0
)

# Guardar modelo final
model.save("models/a2cred_vs_heuristic_v1")
