...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/ppo/red_f4"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
RED_PREV_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_red_f3_v3.zip")
BLUE_FROZEN_MODEL_PATH = os.path.join(MODEL_DIR, "ppo_blue_f4_v1.zip")
...
print("🧊 Cargando modelo azul congelado F4...")
...
# === CREAR Y CARGAR MODELO PPO ROJO ===
print("🧠 Creando modelo PPO rojo (F4) con pesos de F3...")
model = PPO(
    policy="CnnPolicy",
    env=env,
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="ppo_red_f4_v1"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo PPO rojo en Fase 4 vs azul congelado F4...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDAR MODELO ENTRENADO ===
model.save(os.path.join(MODEL_DIR, "ppo_red_f4_v1"))
print("✅ Modelo PPO rojo F4 guardado como ppo_red_f4_v1.zip")
