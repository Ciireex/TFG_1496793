...
# === ENTRENAMIENTO A2C VS HEURÍSTICA v2 ===
print("🏁 Entrenando A2C (azul) vs Heurística v2 (rojo) con obstáculos (1M pasos)...")
env = DummyVecEnv([
...
model = A2C(
    ...
    env,
    verbose=1,
    tensorboard_log="./logs/a2cblue_vs_heuristic_v2/",
    device="cpu"
)

model.learn(
    total_timesteps=1_000_000,
    tb_log_name="A2C_vs_Heuristic_v2",
    reset_num_timesteps=True
)

# Guardar modelo entrenado
model.save("models/a2cblue_vs_heuristic_v2")
