...
LOG_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../logs/dqn/red_f3"))
MODEL_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../models"))
FROZEN_BLUE_PATH = os.path.join(MODEL_DIR, "dqn_blue_f3.zip")
...
callbacks = [
    ...
    CheckpointCallback(
        save_freq=50000,
        save_path=MODEL_DIR,
        name_prefix="dqn_red_f3"
    )
]

# === ENTRENAMIENTO ===
print("🚀 Entrenando modelo DQN rojo F3 (contra azul congelado)...")
model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=callbacks, progress_bar=True)

# === GUARDADO FINAL ===
model.save(os.path.join(MODEL_DIR, "dqn_red_f3"))
print("✅ Modelo DQN rojo F3 guardado como dqn_red_f3.zip")
