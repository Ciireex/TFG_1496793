...
print("🏁 Entrenando MaskablePPO v2 vs heurística (con obstáculos, 1M pasos)...")
env = DummyVecEnv([
    lambda: ActionMasker(
...
model = MaskablePPO(
    ...
    env,
    verbose=1,
    tensorboard_log="./logs/maskableppoblue_vs_heuristic_v2/",
    device="cpu"
)

model.learn(
    total_timesteps=1_000_000,
    tb_log_name="MaskablePPO_vs_Heuristic_v2",
    reset_num_timesteps=True
)

# Guardar modelo final
model.save("models/maskableppoblue_vs_heuristic_v2")

print("\n✅ ENTRENAMIENTO COMPLETADO Y GUARDADO: maskableppoblue_vs_heuristic_v2 ✅")
