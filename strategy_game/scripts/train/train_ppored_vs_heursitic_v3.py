...
from gym_strategy.utils.HeuristicPolicy import HeuristicPolicy  # asegúrate de que es la versión v2 que usa obs
...
# === ENTRENAMIENTO PPO ROJO VS HEURÍSTICA v2 ===
print("🏁 Entrenando PPO (rojo) vs Heurística v2 (azul) con obstáculos (1M pasos)...")
env = DummyVecEnv([
...
model = PPO(
    ...
    env,
    verbose=1,
    tensorboard_log="./logs/pporojo_vs_heuristic_v2/",
    device="cpu"
)

model.learn(
    total_timesteps=1_000_000,
    tb_log_name="PPO_vs_Heuristic_v2_Red",
    reset_num_timesteps=True
)

# Guardar modelo entrenado
model.save("models/pporojo_vs_heuristic_v2")
