...
if __name__ == "__main__":
    print("🏁 Entrenando PPO-CNN (azul) vs Heurística (rojo) en StrategyEnv_CNN...")
    ...
    model = PPO(
        ...
        train_env,
        verbose=1,
        tensorboard_log="./logs/ppo_cnn_v9/",
    ...
    model.learn(
        ...
        tb_log_name="ppo_cnn_v9",
        reset_num_timesteps=True,
        callback=CheckpointCallback(save_freq=100_000, save_path="./models/", name_prefix="ppo_cnn_v9")
    )

    model.save("models/ppo_cnn_v9")
