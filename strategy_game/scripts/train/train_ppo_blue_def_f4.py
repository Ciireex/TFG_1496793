...
MODEL_NAME = "ppo_blue_def_f4"
PRETRAINED_BLUE = "ppo_blue_def_f3"
RED_MODEL = "ppo_red_def_f3"
...
class RedFrozenWrapper_Fase5(Env_Fase5_Knight):
...
def make_env():
    return RedFrozenWrapper_Fase5(model_red)
...
# === ENTRENAMIENTO ===
print(f"🚀 Entrenando PPO azul contra rojo congelado en Fase 5 ({MODEL_NAME})...")
