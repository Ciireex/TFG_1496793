...
print("🏁 FASE 1: Entrenando sin obstáculos (500K)...")
...
model = A2C(
    ...
    env_no_obs,
    verbose=1,
    tensorboard_log="./logs/a2cred_vs_heuristic_curriculum/",
    device="cpu"
)
model.learn(total_timesteps=500_000)

# === FASE 2: Con obstáculos ===
print("🏁 FASE 2: Entrenando con obstáculos (1.5M)...")
...
model.save("models/a2cred_vs_heuristic_curriculum_v1")

print("\n✅ ENTRENAMIENTO COMPLETADO CON A2C (ROJO) VS HEURÍSTICA ✅")
