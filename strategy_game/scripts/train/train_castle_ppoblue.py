...
class DummyHeuristic:
    ...
    def get_action(self, obs):
        return 0  # Acción 0 = pasar (ningún movimiento / ningún ataque)

# === Wrapper PPO vs Dummy ===
...
def make_env():
    def _init():
        ...
        return DualTeamDummyWrapper(base_env, controlled_team=0)
    return _init
...
checkpoint_callback = CheckpointCallback(
    save_freq=50000,
    save_path="./models/",
    name_prefix="ppo_castle_vs_dummy"
)

# === Parámetros de la red y modelo PPO ===
policy_kwargs = dict(
...
model.save("models/ppo_castle_vs_dummy")
