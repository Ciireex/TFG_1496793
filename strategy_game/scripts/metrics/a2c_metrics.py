...
BLUE_DIR = os.path.join(BASE_LOG_DIR, "a2c/blue_f7_v2/A2C_1")
RED_DIR = os.path.join(BASE_LOG_DIR, "a2c/red_f7_v3/A2C_1")
...
plt.tight_layout()
output_path = os.path.join(OUTPUT_DIR, f"a2c_comparativa_blue_vs_red.png")
