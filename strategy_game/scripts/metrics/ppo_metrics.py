...
BLUE_DIR = os.path.join(BASE_LOG_DIR, "ppo/blue_f7_v4/PPO_1")
RED_DIR = os.path.join(BASE_LOG_DIR, "ppo/red_f7_v4/PPO_1")
...
# === Función para cargar métricas desde una carpeta ===
...
plt.tight_layout()
output_path = os.path.join(OUTPUT_DIR, f"ppo_comparativa_blue_vs_red.png")
