...
# === Wrapper para visualización: PPO rojo vs heurística azul ===
...
# === Cargar modelo PPO (equipo rojo) entrenado contra heurística ===
model = PPO.load("models/ppo_red_vs_heuristic_continue", device="cpu")
