...
BLUE_MODEL_PATH = os.path.join(MODEL_DIR, "maskableppo_blue_f3_v1.zip")
RED_MODEL_PATH = os.path.join(MODEL_DIR, "maskableppo_red_f3_v1.zip")

# === CARGA DE MODELOS ===
print("🧠 Cargando modelos MaskablePPO F3...")
...
# === MAIN LOOP DE VISUALIZACIÓN ===
def main():
    pygame.init()
    env = DualMaskableEnvF3()
    obs, _ = env.reset()
    renderer = Renderer(width=600, height=400, board_size=env.board_size)  # 6x4
