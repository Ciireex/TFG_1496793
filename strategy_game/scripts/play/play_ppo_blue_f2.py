...
# Entorno con dos modelos enfrentados
...
def main():
    ...
    model_red = PPO.load("../models/ppo_red_vs_frozenblue/ppo_red_vf1.zip")
    print("✅ Modelos cargados correctamente.")

    print("🎮 Inicializando entorno con obstáculos...")
    ...
    while not done:
        ...
        renderer.draw_board(
            ...
            blocked_positions=(env.terrain == 99)  # 👈 ahora los obstáculos se verán
        )
