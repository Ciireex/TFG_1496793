...
BLUE_MODEL_PATH = os.path.join(MODEL_DIR, "maskableppo_blue_f4_v1.zip")
RED_MODEL_PATH = os.path.join(MODEL_DIR, "maskableppo_red_f4_v1.zip")

# === CARGA DE MODELOS ===
print("🧠 Cargando modelos MaskablePPO F4...")
...
# === ENTORNO PERSONALIZADO PARA VISUALIZACIÓN ===
class DualMaskableEnvF4(Env_Fase4_Archer):
    def __init__(self):
        super().__init__()
