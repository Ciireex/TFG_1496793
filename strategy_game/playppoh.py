...
from HeuristicPolicy import HeuristicPolicy  # Asegúrate de tener esta clase definida

# Cargar modelo PPO entrenado
model = PPO.load("models/ppo_vs_heuristic_v2.zip")
...
# Diccionario de nombres de acción (coincide con dirs)
action_names = {
    0: "pasar",
    1: "←",
    2: "→",
...
while not done:
    ...
    # Si la unidad ya ha muerto por algún motivo, pasar turno
